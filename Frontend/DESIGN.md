...
> **Lunar storefront:** The live UI uses a **gold** brand accent via Tailwind `primary` tokens in `src/index.css` (not Apple Blue). Structure, spacing, and typography notes below remain useful; substitute gold wherever “Apple Blue” appears.
