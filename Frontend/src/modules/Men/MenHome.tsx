...
import { ArrowRight, Sparkles, MoveRight, Layers, Fingerprint } from 'lucide-react';
  ...
  return (
    <PageTransition>
      <div className="bg-background min-h-screen pb-40">
        ...
        <section className="relative h-[80vh] flex items-center overflow-hidden bg-[#050505]">
          ...
          <div className="lunar-container relative z-10">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-[0.85] uppercase italic text-white">
                Refined <br />
                <span className="text-primary font-light not-italic">Identity.</span>
              </h1>
              <p className="text-lg md:text-xl text-white/40 font-medium tracking-tight max-w-md uppercase leading-relaxed">
                Precision-engineered silhouettes meeting the worlds finest sustainable fibers. Engineering style for the modern individual.
              </p>
              <div className="pt-8">
                <button className="btn-luxury px-12 py-5 flex items-center gap-4">
                   EXPLORE SEASONS <ArrowRight className="h-5 w-5" />
                </button>
              </div>
            </motion.div>
          </div>
        ...
        <section className="py-40">
           <div className="lunar-container">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                 ...
                 >
                    <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1200&q=80" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-105" alt="" />
                 ...
                 >
                    <img src="https://images.unsplash.com/photo-1617127365659-c47fa864d8bc?w=800&q=80" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-105" alt="" />
                    <div className="absolute inset-0 bg-black/20 p-10 flex flex-col justify-between">
                       <div className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center">
                          <Layers className="h-5 w-5 text-white" />
                       </div>
                       <div>
                          <h3 className="text-2xl font-black italic text-white uppercase tracking-tighter leading-none">Technical <br />Essentials</h3>
                       </div>
                    </div>
                 </motion.div>
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-20 border-b border-white/5 pb-10">
              <div className="space-y-4">
                ...
                <h2 className="text-5xl md:text-6xl font-black italic tracking-tighter uppercase leading-none">
                  The <br />Men's Edit<span className="text-primary not-italic">.</span>
                </h2>
              </div>
              <div className="flex items-center gap-8 text-[11px] font-bold tracking-widest text-white/40 uppercase">
                 <button className="hover:text-primary transition-colors">BESTSELLERS</button>
          ...
          <div className="lunar-container flex flex-col items-center">
             <div className="max-w-4xl text-center space-y-10">
                ...
                <p className="text-xl text-muted-foreground font-medium uppercase tracking-tight leading-relaxed mx-auto max-w-2xl px-4">
                   Join the LUNAR Inner Circle for private invitations to seasonal drops and bespoke styling consultations.
                </p>
                <div className="pt-10">
                   <Link to="/signup" className="btn-luxury px-16 py-6 inline-block">
                      JOIN THE ARCHIVE
                   </Link>
                </div>
             </div>
