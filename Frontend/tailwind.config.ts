    ...
    extend: {
      ...
      colors: {
        ...
        lunar: {
          ...
          pearl: "hsl(var(--lunar-pearl))",
          gold: "hsl(var(--lunar-gold))",
          charcoal: "hsl(var(--lunar-charcoal))",
        },
        kids: {
      ...
      boxShadow: {
        ...
        deep: "3px 5px 30px rgba(0, 0, 0, 0.22)",
        "lunar-sm": "var(--shadow-sm)",
        "lunar-md": "var(--shadow-md)",
        "lunar-lg": "var(--shadow-lg)",
        "lunar-xl": "var(--shadow-xl)",
      },
    },
  },
